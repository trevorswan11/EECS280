...
static void read_jpeg8(j_decompress_ptr info_p, Image *image)
{
    ...
    JSAMPARRAY buffer2d = (JSAMPARRAY)info_p->mem->alloc_sarray(
        (j_common_ptr)info_p, JPOOL_IMAGE, row_size, 1);
...
static constexpr const char *MISSING_LIBJPEG =
    "========================================================================="
    "\n"
    "Compiled without jpeg support. Make sure that libjpeg or libjpeg-turbo "
    "is\n"
