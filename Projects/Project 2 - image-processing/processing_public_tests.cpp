...
static void test_all(const string &prefix, const vector<int> &sizes,
                     int num_sizes);
                            ...
                            int new_width, int new_height)
{
    ...
    write_image(&carved_img, prefix + "_" + to_string(new_width) + "x" +
                                 to_string(new_height) + OUT_PPM_EXT);

    Image carved_img_correct;
    load_image(&carved_img_correct, prefix + "_" + to_string(new_width) + "x" +
                                        to_string(new_height) + ".correct.ppm");
